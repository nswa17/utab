...
const tournamentSchema = new Schema(
  {
    ...
    total_round_num: {
      ...
      default: 4,
      min: 1,
      validate: { validator: Number.isInteger, message: 'total_round_num must be an integer' },
    },
    current_round_num: {
      type: Number,
      default: 1,
      min: 1,
      validate: { validator: Number.isInteger, message: 'current_round_num must be an integer' },
    },
