const en = {
  ...
  '投票詳細CSV': 'Detailed vote CSV',
  '全ラウンド結果CSV': 'All-round results CSV',
  '順位表CSV': 'Ranking CSV',
  '現在表示しているカテゴリの順位表をCSVで保存します。':
    'Saves the ranking table for the category currently displayed.',
  '表示中: {category}': 'Showing: {category}',
  '表示中の順位表CSVをダウンロード': 'Download current ranking CSV',
  '選択ラウンドの投票詳細': 'Selected-round vote details',
  'Matter/Manner・Best/POI・投票者を、選択した1ラウンド分だけ保存します。':
    'Saves Matter/Manner, Best/POI, and voter data for the selected round only.',
  '選択ラウンドの投票詳細CSV': 'Selected-round vote details CSV',
  '全ラウンドの投票詳細': 'All-round vote details',
  '同じ投票詳細を、全ラウンド分まとめて1つのCSVで保存します。':
    'Saves the same vote details for every round in one CSV file.',
  '全ラウンドの投票詳細CSV': 'All-round vote details CSV',
  '個別ダウンロード': 'Individual downloads',
  '一括ダウンロード': 'Bulk download',
  '結果一式をZIPでダウンロード': 'Download all results (ZIP)',
  '順位表・参加者一覧・全ラウンドの投票詳細をまとめてダウンロードします。':
    'Downloads rankings, participants, and all-round vote details in one ZIP file.',
  'ダウンロード内容: {count} ファイル': '{count} files included',
  'スピーカーごとのMatter/Manner・Best/POIと投票者を出力します。':
    'Exports each speaker’s Matter/Manner, Best/POI, and voter.',
  ...
  '勝者はチームA/チームBのいずれかを指定してください。': 'Winner must be either Team A or Team B.',
  '提出者はジャッジから選択してください。':
    'For team evaluations, select the submitter from adjudicators.',
  'チーム A の Matter/Manner 件数を一致させてください。': 'Team A Matter/Manner counts must match.',
  'チーム B の Matter/Manner 件数を一致させてください。': 'Team B Matter/Manner counts must match.',
  ...
  '{adj} と {team} に{group}衝突': '{group} conflict between {adj} and {team}',
  '{adj} は {team} を既に担当済み': '{adj} has already judged {team}',
  '{a} と {b} が同一機関です': '{a} and {b} are from the same institution',
  '{a} と {b} が同一{group}です': '{a} and {b} are from the same {group}',
  '{a} と {b} の勝利数が異なります': '{a} and {b} have different win counts',
  '{a} と {b} は過去に対戦済みです': '{a} and {b} have faced before',
  '{a} と {b} は同一機関の別チームと過去対戦があります':
    '{a} and {b} have already faced another team from the same institution',
  '{a} と {b} は同一{group}の別チームと過去対戦があります':
    '{a} and {b} have already faced another team from the same {group}',
  '{count} 件': '{count} items',
  '{count}件': '{count} items',
  ...
  'あなたの情報': 'Your details',
  'あなたの投票': 'Your decision',
  '選択した賞': 'Selected awards',
  ...
  '入力ステップ': 'Entry steps',
  '入力可能なロールがありません。': 'No roles are available for entry.',
  '前のロール': 'Previous role',
  '勝者は点数の大小と一致させてください。': 'The winner must match the higher score.',
  '勝者または引き分けを選択してください。': 'Select a winner or draw.',
  '勝者入力': 'Select winner',
  '引き分けは同点時のみ選択できます。': 'A draw can be selected only when scores are tied.',
  '提出候補の制限がないため、全ジャッジを表示しています。':
    'All adjudicators are shown because no submitter candidates are restricted.',
  '提出者ジャッジ': 'Submitting adjudicator',
  '提出者ジャッジを選択してください。': 'Select the submitting adjudicator.',
  '提出者入力': 'Select submitter',
  '次のロール': 'Next role',
  '次へ': 'Next',
  '確認へ': 'Review',
  '確認画面に戻る': 'Back to review',
  ...
  '新規仮集計': 'New preview compile',
  '既存レポート': 'Existing reports',
  '新規仮集計（必須）': 'New preview compile (Required)',
  '既存レポート（任意）': 'Existing reports (Optional)',
  'Step 1: ラウンド選択': 'Step 1: Select round',
  'Step 2: 集計実行': 'Step 2: Run compile',
  'Step 2: 仮集計実行': 'Step 2: Run preview compile',
  'Step 3: 集計結果を保存': 'Step 3: Save compiled result',
  'ラウンド選択': 'Select rounds',
  '集計実行': 'Run compile',
  '最新ラウンドを初期選択しています。必要に応じて変更してください。':
    'The latest round is preselected. Change it if needed.',
  '選択中: {round}': 'Selected: {round}',
  'このラウンドで仮集計': 'Preview compile this round',
  '未提出: Ballot {ballot} / Feedback {feedback}':
    'Missing: Ballot {ballot} / Feedback {feedback}',
  '要確認: 重複 {duplicates} / 不明 {unknown}':
    'Needs review: Duplicates {duplicates} / Unknown {unknown}',
  '仮集計の結果を確認したら保存します。': 'Review preview results, then save.',
  '表示したい保存済みレポートを選択します。': 'Select a saved report to display.',
  '保存済みレポートがありません。': 'No saved reports.',
  '集計フェーズ': 'Result phase',
  ...
  '準優勝': 'Grand Finalist',
  '準決勝進出': 'Semi-finalist',
  '準々決勝進出': 'Quarter-finalist',
  'ベスト16': 'Octo-finalist',
  'ベスト32': 'Double-octo-finalist',
  'ブレイク参加者': 'Break participant',
  'Champion': 'Champion',
  ...
  'Bubble Pressure: {level}（スコア {score}）': 'Bubble Pressure: {level} (score {score})',
  ...
  '正常': 'OK',
  '警告凡例': 'Warning legend',
  '警告色の凡例': 'Warning color key',
  '赤: 同一機関・利用不可などの重大な競合': 'Red: same institution, unavailable, or other critical conflicts',
  '橙: 過去の対戦': 'Orange: previous opponents',
  '過去の対戦': 'Previous opponents',
  '黄: 過去に担当済み・サイド偏りなど': 'Yellow: previously judged teams, side imbalance, and other cautions',
  '青: 同地域・同リーグなどの参考情報': 'Blue: same region, league, and other reference information',
  '種別': 'Type',
  '経過(分)': 'Elapsed (min)',
  '提出時刻': 'Submitted at',
  ...
  '必要な場合のみ詳細再計算を実行してください。': 'Run detailed recomputation only when needed.',
  ...
  'このラウンドまでを提出データで集計します。': 'Compile using submission data up to this round.',
  'このラウンドまでを生結果データで集計します。': 'Compile using raw results up to this round.',
  '対戦生成と保存は対戦表設定で実行します。': 'Generate and save pairings from draw settings.',
  ...
  '大会トップ': 'Tournament top',
  '大会トップに戻る': 'Back to tournament top',
  '参加者ホーム': 'Participant home',
  '参加者ダッシュボード': 'Tournament top',
  '入力開始': 'Start input',
  ...
  '先に評価対象ジャッジを選択してください。': 'Select a target adjudicator first.',
  ...
  '担当チーム': 'Judged teams',
  '共同担当ジャッジ': 'Previous co-adjudicators',
  '担当数': 'Times judged',
  '提出': 'Submissions',
  ...
  'ラウンド作成は大会セットアップで行います。': 'Create rounds from tournament setup.',
  ...
  'ブレイクラウンド未設定のため無効': 'Disabled because no break round is configured.',
  ...
  'チームからのフィードバック入力を有効にします。': 'Enable feedback input submitted by teams.',
  ...
  '重複するジャッジフィードバックの送信を許可': 'Allow duplicate adjudicator feedback submissions',
  ...
  '勝者のスコアが敗者のスコアより高いことを要求': 'Require winner score > loser score',
  '勝敗とスコアの大小が違うことを許容': 'Allow winner/score mismatch',
  'スコア推定のみ': 'Infer by score only',
  '未指定は引き分け': 'Treat missing winner as draw',
  '勝者未指定は引き分け扱い': 'Treat missing winner as draw',
  '引き分けを許容（勝者未指定は引き分け扱い）':
    'Allow draws (treat missing winner as draw when winner is missing)',
  ...
  'ここで選んだラウンドだけを集計します。': 'Only selected rounds are compiled.',
  ...
  '対象ラウンドと集計オプションを確認します。': 'Confirm target rounds and compile options.',
  ...
  'プレビューを更新してから保存してください。': 'Refresh preview before saving.',
  '仮集計を実行してから保存してください。': 'Run preview compile before saving.',
  ...
  '表示対象の集計結果IDが必要です。': 'A target compile-result ID is required.',
  ...
  'ヘルプ:引き分けポイント': 'Points assigned to each team on draws. Default is 0.5.',
  'ヘルプ:重複マージ':
    'Choose latest, average merge, or strict error when duplicate submissions exist.',
  'ヘルプ:POI集計': 'Choose average or max aggregation for POI across duplicate submissions.',
  'ヘルプ:Best集計':
  ...
  'ヘルプ:生成対象': 'Choose which result labels to generate and display.',
  'ヘルプ:差分比較':
  ...
  '名前/コンフリクトグループ/スピーカーで検索': 'Search by name/conflict group/speaker',
  ...
  '評価対象ジャッジID': 'Target adjudicator ID',
  ...
  '衝突回避のスワップ試行上限です。': 'Maximum number of swap attempts for conflict avoidance.',
  ...
  '標準または伝統的な割当方法を選択します。': 'Select standard or traditional allocation.',
  ...
  'スピーカー成績': 'Speaker performance',
  'ジャッジ成績': 'Adjudicator performance',
...
const jaOverrides: Record<string, string> = {
  ...
  'スコアシートを開始するチームを選択してください。':
    'チーム評価を開始する対戦を選択してください。',
