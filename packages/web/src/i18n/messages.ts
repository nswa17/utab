const en = {
  ...
  ジャッジ: 'Judge',
  'ジャッジ: {name}': 'Judge: {name}',
  'ジャッジが登録されていません。': 'No judges registered.',
  'ジャッジのフィードバックを入力してください。': 'Enter feedback for the judge.',
  ジャッジをドロップ: 'Drop adjudicator',
  'ジャッジを削除しますか？': 'Delete this judge?',
  ...
  ジャッジ人数が偶数: 'Even number of judges',
  ジャッジ人数が偶数です: 'Number of judges is even',
  ジャッジ割り当て公開: 'Adjudicator allocation open',
  ジャッジ同士の機関衝突: 'Institution conflict between judges',
  ジャッジ未割当: 'No adjudicator assigned',
  スコア: 'Score',
  スコアシート: 'Score sheet',
  'スコアシートはドローから選択できます。': 'Select a ballot from the draw.',
  スコアシートへ: 'Go to ballot',
  'スコアシートを開始するチームを選択してください。': 'Select teams to start a ballot.',
  ...
  '参加者ホームでジャッジを選択すると、評価対象を絞り込めます。':
    'Selecting a judge on the participant home filters evaluables.',
  ...
  大会管理: 'Tournament admin',
  大会管理へログイン: 'Log in to tournament admin',
  ...
  対象: 'Scope',
  '対象のジャッジが見つかりません。': 'Target judge not found.',
  ...
  '評価するジャッジを選択してください。': 'Select a judge to evaluate.',
  ...
  詳細: 'Details',
  チーム詳細: 'Team details',
  ジャッジ詳細: 'Judge details',
  会場詳細: 'Venue details',
  選択中のチーム詳細: 'Selected team details',
  選択中のジャッジ詳細: 'Selected judge details',
  ...
  '重複するジャッジフィードバックの送信を許可':
    'Allow duplicate judge feedback submissions',
  ...
  '重複: チーム評価 {ballot} / ジャッジフィードバック {feedback}':
    'Duplicates: score sheets {ballot} / judge feedback {feedback}',
