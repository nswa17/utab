...
export type BallotAwardSelectionInput = {
  bestA?: boolean[] | null | undefined
  bestB?: boolean[] | null | undefined
  poiA?: boolean[] | null | undefined
  poiB?: boolean[] | null | undefined
}
...
export function resolveRoundAwardSelectionValidationRules(
  userDefinedData: unknown
...
export function countSelectedFlags(values: boolean[] | null | undefined): number {
  if (!Array.isArray(values)) return 0
  return values.reduce((count, value) => count + (value ? 1 : 0), 0)
}

function hasSelectionInput(
...
export function validateAwardSelectionCounts(
