...
describe('results/compileTeamResults (advanced)', () => {
  ...
  it('keeps fractional win points for ties', () => {
    const teams = [
      { id: 't1', details: [{ r: 1, speakers: ['s1'] }] },
      { id: 't2', details: [{ r: 1, speakers: ['s2'] }] },
    ]
    const speakers = [{ id: 's1' }, { id: 's2' }]
    const rawTeamResults = [
      { id: 't1', r: 1, win: 0.5, opponents: ['t2'], side: 'gov' },
      { id: 't2', r: 1, win: 0.5, opponents: ['t1'], side: 'opp' },
    ]
    const rawSpeakerResults = [
      { id: 's1', r: 1, scores: [76] },
      { id: 's2', r: 1, scores: [74] },
